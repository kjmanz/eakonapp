              ...
              <Card elevation={0} sx={{ border: '1px solid #e2e8f0' }}>
                ...
                >
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                      <Box sx={{ p: 2, bgcolor: 'white', textAlign: 'center', borderRadius: 2, border: '1px solid #e2e8f0' }}>
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                      <Box sx={{ p: 2, bgcolor: 'white', textAlign: 'center', borderRadius: 2, border: '1px solid #e2e8f0' }}>
                        ...
                        <Typography variant="h6" fontWeight="700" color="info.main">
                          {calculateComparison.oldCleaningTime}時間 → {calculateComparison.newAC.autoCleaning ? '0' : '60'}時間
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          {calculateComparison.newAC.autoCleaning ? '≒ 有給15日分' : '≒ 有給7.5日分'}
                        </Typography>
                      </Box>
                    </Grid>
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                      <Box sx={{ p: 2, bgcolor: 'white', textAlign: 'center', borderRadius: 2, border: '1px solid #e2e8f0' }}>
                        <EcoIcon sx={{ fontSize: 32, mb: 1, color: '#22c55e' }} />
